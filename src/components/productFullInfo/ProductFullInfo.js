  ...
  return (
    <>
      <div className="overlay">
        ...
        <button onClick={onBack} type="button" className="productFullInfo_back_btn">❮ Назад</button>
          ...
          <p className="productFullInfo_shoe_description">Кроссовки Air Jordan 1 Mid, дизайн которых вдохновлен оригинальной
          <br/> моделью AJ1, дают фанатам возможность пойти по стопам Майкла
          <br/> Джордана. Элементы отделки свежих цветов и классические материалы
          <br/> привносят новизну в привычный образ.</p>
          <p className="productFullInfo_color_model">Цвет модели:</p>
          <button onClick={onAddToKorzina} type="button" className="productFullInfo_addToBasket_btn">
            Добавить в корзину
          </button>
        </div>
      </div>
